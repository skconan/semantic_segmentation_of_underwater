...
def build_generator_resnet_6blocks(inputgen, name="generator"):
    with tf.variable_scope(name):
        ...
        # o_c4 = general_deconv2d(o_r6, [batch_size,484//4,304//4,ngf*2], ngf*2, ks, ks, 2, 2, 0.02,"SAME","c4")
        # o_c5 = general_deconv2d(o_c4, [batch_size,484//2,304//2,ngf], ngf, ks, ks, 2, 2, 0.02,"SAME","c5")
...
def build_generator_resnet_9blocks(inputgen, name="generator"):
    with tf.variable_scope(name):
        ...
        # o_c4 = general_deconv2d(o_r9, [batch_size,484//2,304//2,ngf*2], ngf*2, ks, ks, 2, 2, 0.02,"SAME","c4")
        # o_c5 = general_deconv2d(o_c4, [batch_size,484,304,ngf], ngf, ks, ks, 2, 2, 0.02,"SAME","c5")
