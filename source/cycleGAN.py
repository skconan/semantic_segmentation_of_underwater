...
class CycleGAN():
    ...
    def model_setup(self):
        ...
        self.input_B = tf.placeholder(
            tf.float32, [batch_size, img_height, img_width, img_layer], name="input_B")
        ...
        with tf.variable_scope("Model") as scope:
            ...
            self.fake_B = build_generator_resnet_6blocks(
                self.input_A, name="g_A")
            self.fake_A = build_generator_resnet_6blocks(
                self.input_B, name="g_B")
    ...
    def train(self):
        ''' Training Function '''
        self.save_training_images_input = True
